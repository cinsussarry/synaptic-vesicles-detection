...
training_dataset = datasets.ImageFolder(root=os.path.join(
    'data_second_classifier', 'train'), transform=transform_train)
...
validation_dataset = datasets.ImageFolder(root=os.path.join(
    'data_second_classifier', 'val'), transform=transform_val)
...
# print the results
    ...
    torch.save(model.state_dict(), os.path.join('/Users/Milagros/Downloads', 'model_dir2',
                                                'epoch-{}.pth'.format(e)))
